...
const Navbar = () => {
  ...
  return (
    <nav className="top-0 fixed w-full xl:max-w-screen-xl max-w-full h-20 mx-auto flex items-stretch justify-between flex-wrap p-0 transition duration-500 bg-white text-black z-50">
